(() => {
  ...
  const translations = {
    en: {
      ...
      'uploadSteps':['Register or log in.','Click the Upload button.','Enter the required information.','Upload the bot data.','Upload the thumbnail image and preview images.'],
    ...
    ja: {
      ...
      'uploadSteps':['登録またはログインする。','アップロードボタンを押す。','必要事項を入力する。','ボットデータをアップロードする。','サムネイル画像とプレビュー用の画像をアップロードする。'],
